...
let andreasb = new Name(/*høyde*/ 'høy', /*hår*/ 'brun', /*klasse*/ 'b', /*jobb*/ 'elev', /*kjønn*/ 'gutt', /*polakk*/ 'nei', /*i i fornavnet*/ 'nei', /*briller*/ 'ja', /*hårlengde*/ 'kort', /*stavelser*/ '3+', /*gruppe*/ '2', /*ddette er den siste; navn*/ 'Andreas B'); 
...
let l = 0
    ...
    function game(){
        let hvilbil = Math.floor(Math.random()*3)
            if(hvilbil === 0){
                document.getElementById('pain').style.display='flex'
                document.getElementById('caramel').style.display='none'
                document.getElementById('krinator').style.display='none'
                document.getElementById('seier').style.display='none'
                document.getElementById('sjokk').style.display='none'
            }
            else if(hvilbil === 1){
                document.getElementById('caramel').style.display='flex'
                ...
                document.getElementById('krinator').style.display='none'
                document.getElementById('seier').style.display='none'
                document.getElementById('sjokk').style.display='flex'
            }
            else{
                console.log('a')
            }
        ...
        if(list.length === 1){
            ...
            document.getElementById('sjokk').style.display='none'
            document.getElementById('krinator').style.display='none'
            document.getElementById('seier').style.display='flex'
        }
        if (list.length === 0) {
